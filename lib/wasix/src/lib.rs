...
fn wasix_exports_32(mut store: &mut impl AsStoreMut, env: &FunctionEnv<WasiEnv>) -> Exports {
    ...
    let namespace = namespace! {
        ...
        "dl_close" => Function::new_typed_with_env(&mut store, env, dl_close::<Memory32>),
        "dl_error" => Function::new_typed_with_env(&mut store, env, dl_error::<Memory32>),
        "dl_load_symbol" => Function::new_typed_with_env(&mut store, env, dl_load_symbol::<Memory32>),
        "dl_open" => Function::new_typed_with_env(&mut store, env, dl_open::<Memory32>),
        "environ_get" => Function::new_typed_with_env(&mut store, env, environ_get::<Memory32>),
        "environ_sizes_get" => Function::new_typed_with_env(&mut store, env, environ_sizes_get::<Memory32>),
...
fn wasix_exports_64(mut store: &mut impl AsStoreMut, env: &FunctionEnv<WasiEnv>) -> Exports {
    ...
    let namespace = namespace! {
        ...
        "dl_close" => Function::new_typed_with_env(&mut store, env, dl_close::<Memory64>),
        "dl_error" => Function::new_typed_with_env(&mut store, env, dl_error::<Memory64>),
        "dl_load_symbol" => Function::new_typed_with_env(&mut store, env, dl_load_symbol::<Memory64>),
        "dl_open" => Function::new_typed_with_env(&mut store, env, dl_open::<Memory64>),
